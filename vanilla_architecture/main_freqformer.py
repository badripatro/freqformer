...
import utils
from freqformer import FreqFormer
...
def main(args):
    ...
    if args.finetune:
        ...
        if args.arch in ['freqformer-ti', 'freqformer-xs', 'freqformer-s', 'freqformer-b']:
            num_patches = (args.input_size // 16) ** 2
        elif args.arch in ['freqformer-h-ti', 'freqformer-h-s', 'freqformer-h-b']:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('freqformer training and evaluation script', parents=[get_args_parser()])
