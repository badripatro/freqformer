...
from freqformer import FreqFormer, _cfg

def get_args_parser():
    parser = argparse.ArgumentParser('freqformer evaluation script', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('freqformer evaluation script', parents=[get_args_parser()])
